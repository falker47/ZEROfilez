...
export const ITEMS = {
    "emulation": {
        ...
        "psp": {
            ...
            "subtext": "PPSSPP",
            "pc": {
                "url": "https://www.ppsspp.org/files/1_24_640/PPSSPPSetup.exe"
            },
            "android": {
    ...
    "pc-programs": {
        ...
        "powertoys": { "id": "powertoys", "name": "PowerToys", "url": "https://github.com/microsoft/PowerToys/releases/download/v0.99.0/PowerToysUserSetup-0.99.0-x64.exe", "icon": ICONS.powertoys },
