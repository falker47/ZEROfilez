...
export const ITEMS = {
    "emulation": {
        ...
        "ps3": {
            ...
            "subtext": "RPCS3",
            "pc": {
                "url": "https://github.com/RPCS3/rpcs3-binaries-win/releases/download/build-09d602fd5a15d1ca92c9ab9927322d0b185eb45b/rpcs3-v0.0.41-19512-09d602fd_win64_msvc.7z"
            },
            "android": null
        },
        "xemu": {
    ...
    "pc-programs": {
        ...
        "cheat-engine": { "id": "cheat-engine", "name": "Cheat Engine", "url": "https://d3px5ihclumdo8.cloudfront.net/DKTNSdR/tmp8.exe", "icon": ICONS.cheatEngine },
        ...
        "powertoys": { "id": "powertoys", "name": "PowerToys", "url": "https://github.com/microsoft/PowerToys/releases/download/v0.100.1/PowerToysUserSetup-0.100.1-x64.exe", "icon": ICONS.powertoys },
