...
export const ITEMS = {
    "emulation": {
        ...
        "switch": {
            ...
            "android": {
                "url": "https://git.eden-emu.dev/eden-emu/eden/releases/download/v0.2.0-rc2/Eden-Android-v0.2.0-rc2-standard.apk"
            }
        },
        "scummvm": {
            "id": "scummvm",
        ...
        "psp": {
            ...
            "subtext": "PPSSPP",
            "pc": {
                "url": "https://www.ppsspp.org/files/1_24_380/PPSSPPSetup.exe"
            },
            "android": {
    ...
    "pc-programs": {
        ...
        "powertoys": { "id": "powertoys", "name": "PowerToys", "url": "https://github.com/microsoft/PowerToys/releases/download/v0.98.1/PowerToysUserSetup-0.98.1-x64.exe", "icon": ICONS.powertoys },
        ...
        "antigravity": { "id": "antigravity", "name": "Google Antigravity", "url": "https://edgedl.me.gvt1.com/edgedl/release2/j0qc3/antigravity/stable/1.22.2-5206900187463680/windows-x64/Antigravity.exe", "icon": ICONS.antigravity }
    },
    "apk-files": {
